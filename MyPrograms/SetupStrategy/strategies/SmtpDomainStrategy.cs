...
{
    public class SmtpDomainStrategy:SetupStrategyAbstract
    {
        public SmtpDomainStrategy(SetUpDAL dbIn, string user)
            : base(dbIn, user)
        {
            /// <summary>
            ...
            base.fieldName = SetupEnum.SmtpDomain.ToString();

            //This is the description the item has
            base.description = "Email SMTP: Your SMTP Domain";
